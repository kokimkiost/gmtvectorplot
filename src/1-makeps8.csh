...
vectorplot format.in3 regend.xyuv $scale2 | psxy -R -JX -W1,0/255/0 -m -K -O >> $case.ps
vectorplot format.in4 regend.xyuv $scale2 | psxy -R -JX -G0/255/0 -m -K -O >> $case.ps
vectorplot format.in5 regend.xyuv $scale2 | psxy -R -JX -W1,255/0/0 -m -K -O >> $case.ps
vectorplot format.in6 regend.xyuv $scale2 | psxy -R -JX -G255/0/0 -m -K -O >> $case.ps
